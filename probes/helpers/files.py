import json
import shutil
from .config import cube_map_face_names
import os
...
def cubemap_files(export_directory, name, extension):
...
def pano_file(export_directory, name, extension):
    dir = get_render_cache_subdirectory(export_directory, name)
    return dir + "/" + pano_filename(extension)


def global_pano_filename(name, extension):
...
def irradiance_filename(index_x, index_y, index_z, extension):
    return str(index_x) + "_" + str(index_y) + "_" + str(index_z) + "." + extension


def irradiance_file(export_directory, name, index_x, index_y, index_z, extension):
    dir = get_render_cache_subdirectory(export_directory, name)
